        ...
        if (link.url === "/logout") {
          return (
            <Link
              ...
              className="flex items-center gap-x-5 md:w-12 md:h-12 md:justify-center md:rounded-xl text-icon-color last:mt-auto last:bg-white last:shadow-sdprimary  w-full p-5"
              key={link.name}
            >
              <span>{link.icon}</span>
